/* behavior_inc_scale_divisor_max.c */
...
/* Increase function */
static int on_inc_scale_divisor_max(struct zmk_behavior_binding *binding,
                                    struct zmk_behavior_binding_event event)
{
    if (event.press) {
        ...
        if (scale_divisor_max > SCALE_DIVISOR_MAX_MAX) {
            scale_divisor_max = SCALE_DIVISOR_MAX_MAX;
        }
...
static const struct behavior_driver_api behavior_inc_api = {
    .binding_pressed = on_inc_scale_divisor_max,
};

/* Device registration */
DEVICE_DT_INST_DEFINE(DT_NODELABEL(inc_scale_divisor_max), NULL, NULL, NULL, NULL,
